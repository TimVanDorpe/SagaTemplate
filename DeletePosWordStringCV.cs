...
{
    public class DeletePosWordStringCV : CommandValidator<DeletePosWordStringCMD>
    {
        private readonly PosWordStringRepository repository;

        public DeletePosWordStringCV(
            ILogger logger,
        ...
        public override async Task<Result> ExecuteAsync(DeletePosWordStringCMD command, string ruleSet = null)
        {
            // Conditions
