...
{
    public class DeleteAPosWordStringCH : CommandHandler<DeleteAPosWordStringCMD, PosWordStringAR>
    {
        ...
        protected override async Task ExecuteAsync(DeleteAPosWordStringCMD command)
        {
            // Conditions
