...
{
    public class CreateAPosWordStringCV : CommandValidator<CreateAPosWordStringCMD>
    {
        private readonly PosWordStringRepository repository;

        public CreateAPosWordStringCV(
            ILogger logger,
        ...
        public override async Task<Result> ExecuteAsync(CreateAPosWordStringCMD command, string ruleSet = null)
        {
            // Conditions
