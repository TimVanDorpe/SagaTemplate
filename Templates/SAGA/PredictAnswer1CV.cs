...
{
    public class PredictAnswer1CV : NsbMessageValidator<PredictAnswer1CMD>
    {
        private readonly PredictionRepository _repository;

        public PredictAnswer1CV(
        ...
        public override async Task<Result> ExecuteAsync(PredictAnswer1CMD message)
        {
            // Conditions
