...
{
    public class PredicteAnswer2CH : NsbMessageHandler<PredicteAnswer2CMD, PredictionAR>
    {       
        private readonly PredictionRepository _repository;

        public PredicteAnswer2CH(
        ...
        public override async Task ExecuteAsync(PredicteAnswer2CMD command, IMessageHandlerContext context)
        {
            // Conditions
        ...
        public override AsyncPollingInfo ConfigureAsyncPolling()
        {
            return AsyncPollingInfo.Create(
                 ...
                 message: PredicteAnswerState.Step2);
        }
    }
}      
