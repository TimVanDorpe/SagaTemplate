...
{
    public class PredictAnswer2CH : NsbMessageHandler<PredictAnswer2CMD, PredictionAR>
    {       
        private readonly PredictionRepository _repository;

        public PredictAnswer2CH(
        ...
        public override async Task ExecuteAsync(PredictAnswer2CMD command, IMessageHandlerContext context)
        {
            // Conditions
