...
{
    public class PredicteAnswer2CV : NsbMessageValidator<PredicteAnswer2CMD>
    {
        private readonly TenantRepository _repository;

        public PredicteAnswer2CV(
        ...
        public override async Task<Result> ExecuteAsync(PredicteAnswer2CMD message)
        {
            // Conditions
