...
{
    public class ParticipantAnswer1CV : NsbMessageValidator<ParticipantAnswer1CMD>
    {
        private readonly AnswerRepository repository;

        public ParticipantAnswer1CV(
        ...
        public override async Task<Result> ExecuteAsync(ParticipantAnswer1CMD message)
        {
            // Conditions
