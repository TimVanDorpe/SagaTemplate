...
{
    public class RunUnitTest2CH : NsbMessageHandler<RunUnitTest2CMD, UnitTestAR>
    {       

        public RunUnitTest2CH(
        ...
        public override async Task ExecuteAsync(RunUnitTest2CMD command, IMessageHandlerContext context)
        {
            // Conditions
