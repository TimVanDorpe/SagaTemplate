...
{
    public class PredictAnswer1CH : NsbMessageHandler<PredictAnswer1CMD, PredictionAR>
    {       
        private readonly PredictionRepository _repository;

        public PredictAnswer1CH(
        ...
        public override async Task ExecuteAsync(PredictAnswer1CMD command, IMessageHandlerContext context)
        {
            // Conditions
        ...
        public override AsyncPollingInfo ConfigureAsyncPolling()
        {
            return AsyncPollingInfo.Create(
                 ...
                 message: PredictAnswerState.Step1);
        }
    }
}      
