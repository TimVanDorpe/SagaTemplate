...
{
    public class ParticipantAnswer2CV : NsbMessageValidator<ParticipantAnswer2CMD>
    {
        private readonly AnswerRepository repository;

        public ParticipantAnswer2CV(
        ...
        public override async Task<Result> ExecuteAsync(ParticipantAnswer2CMD message)
        {
            // Conditions
