...
{
    public class RunUnitTest1CV : NsbMessageValidator<RunUnitTest1CMD>
    {
        private readonly UnitTestRepository repository;

        public RunUnitTest1CV(
        ...
        public override async Task<Result> ExecuteAsync(RunUnitTest1CMD message)
        {
            // Conditions
