...
{
    public class RunUnitTest1CH : NsbMessageHandler<RunUnitTest1CMD, UnitTestAR>
    {       

        public RunUnitTest1CH(
        ...
        public override async Task ExecuteAsync(RunUnitTest1CMD command, IMessageHandlerContext context)
        {
            // Conditions
        ...
        public override AsyncPollingInfo ConfigureAsyncPolling()
        {
            return AsyncPollingInfo.Create(
                 ...
                 message: RunUnitTestState.Step1);
        }
    }
}      
