...
{
    public class ParticipantAnswer1CH : NsbMessageHandler<ParticipantAnswer1CMD, AnswerAR>
    {       

        public ParticipantAnswer1CH(
        ...
        public override async Task ExecuteAsync(ParticipantAnswer1CMD command, IMessageHandlerContext context)
        {
            // Conditions
        ...
        public override AsyncPollingInfo ConfigureAsyncPolling()
        {
            return AsyncPollingInfo.Create(
                 ...
                 message: ParticipantAnswerState.Step1);
        }
    }
}      
