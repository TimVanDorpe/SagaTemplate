...
{
    public class ParticipantAnswer2CH : NsbMessageHandler<ParticipantAnswer2CMD, AnswerAR>
    {       

        public ParticipantAnswer2CH(
        ...
        public override async Task ExecuteAsync(ParticipantAnswer2CMD command, IMessageHandlerContext context)
        {
            // Conditions
        ...
        public override AsyncPollingInfo ConfigureAsyncPolling()
        {
            return AsyncPollingInfo.Create(
                 ...
                 message: ParticipantAnswerState.Step2);
        }
    }
}      
