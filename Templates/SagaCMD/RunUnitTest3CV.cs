...
{
    public class RunUnitTest3CV : NsbMessageValidator<RunUnitTest3CMD>
    {
        private readonly UnitTestRepository repository;

        public RunUnitTest3CV(
        ...
        public override async Task<Result> ExecuteAsync(RunUnitTest3CMD message)
        {
            // Conditions
